...
activities = {
    ...
    "Soccer Team": {
        "description": "Team soccer practice and interscholastic matches",
        "schedule": "Mondays, Wednesdays, Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["alex@mergington.edu", "jordan@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Skill-building drills and friendly basketball games",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 16,
        "participants": ["taylor@mergington.edu", "nina@mergington.edu"]
    },
    "Art Studio": {
    ...
    "Choir": {
        "description": "Vocal practice and performances for school events",
        "schedule": "Tuesdays and Thursdays, 3:30 PM - 4:45 PM",
        "max_participants": 25,
        "participants": ["mia@mergington.edu", "julian@mergington.edu"]
    },
    "Math Olympiad": {
...
@app.delete("/activities/{activity_name}/participants/{participant}")
def remove_participant(activity_name: str, participant: str):
